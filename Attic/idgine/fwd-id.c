/** \file
 *
 * This file implements a command-line client for forwarding an identity
 * to an identity reciprocation server.
 */
...

{
	...
	if ( !duct->init_port(duct, host->get(host), IDRECIP_PORT) ) {
