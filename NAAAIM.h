...
#define NAAAIM_PossumPipe_OBJID		25

#define NAAAIM_Netconfig_OBJID		26
#define NAAAIM_IPsec_OBJID		27
#define NAAAIM_SoftwareTPM_OBJID	28
#define NAAAIM_TPMcmd_OBJID		29
