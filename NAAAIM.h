...
#define NAAAIM_Netconfig_OBJID		31
#define NAAAIM_IPsec_OBJID		32
#define NAAAIM_SoftwareTPM_OBJID	33
#define NAAAIM_IDengine_OBJID		34
#define NAAAIM_Identity_OBJID		35
#define NAAAIM_EDIpacket_OBJID		36
#define NAAAIM_MGMTsupvr_OBJID		37

#define NAAAIM_SGXmetadata_OBJID	38
#define NAAAIM_SGXloader_OBJID		39
#define NAAAIM_SGXenclave_OBJID		40
#define NAAAIM_SGXsigstruct_OBJID	41
#define NAAAIM_SGXepid_OBJID		42

#define NAAAIM_Actor_OBJID		43
#define NAAAIM_Subject_OBJID		44
#define NAAAIM_ExchangeEvent_OBJID	45
#define NAAAIM_ISOidentity_OBJID	46
#define NAAAIM_ContourPoint_OBJID	47
#define NAAAIM_ISOenclave_OBJID		48
#define NAAAIM_PVEenclave_OBJID		49
#define NAAAIM_SGXmessage_OBJID		50
#define NAAAIM_SGXecdsa_OBJID		51
#define NAAAIM_PCEenclave_OBJID		52
#define NAAAIM_SGXcmac_OBJID		53
#define NAAAIM_SGXaesgcm_OBJID		54
#define NAAAIM_SGXrsa_OBJID		55
#define NAAAIM_QEenclave_OBJID		56
