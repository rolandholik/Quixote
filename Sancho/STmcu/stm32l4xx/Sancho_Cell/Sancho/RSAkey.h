...
#ifndef HurdLib_RSAkey_HEADER
#define HurdLib_RSAkey_HEADER


/* Object type definitions. */
typedef struct HurdLib_RSAkey * RSAkey;

typedef struct HurdLib_RSAkey_State * RSAkey_State;
