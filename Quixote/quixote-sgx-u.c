 ...
 * stacks in an SGX disciplined security domain.  After creating an
 ...
 * Private function.
 *
 * This function is responsible for the processing of TSEM security
...

{
	...
	/* Send each coefficient in the model. */
