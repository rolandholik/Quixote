/** \file
 * This file contains an implementation of the device identity broker
 * server.   This server is responsible for arbitrating identity
 * authentication requests for a device.
 *
 * The server accepts an identity broker request which consists of
 * a device authenticator.  The authenticator is decrypted and
...
/* Local defines. */
#define SERVER "Device Authentication Broker"
